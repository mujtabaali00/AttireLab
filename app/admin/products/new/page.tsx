...
export default function NewProductPage() {
  ...
  // State to track individual spec image uploads
  ...
  // Auto-sum quantity if specifications exist
  useEffect(() => {
  ...
  // Keep form in sync with uploaded URLs
  useEffect(() => {
    ...
    <div className="p-6 lg:p-8 max-w-4xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              />
              {specFields.length > 0 && <p className="text-[10px] text-gray-500 mt-1">Auto-calculated from specifications</p>}
                  ...
                  <div className="col-span-12 sm:col-span-9 grid grid-cols-2 md:grid-cols-4 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full border border-gray-300 rounded text-xs px-2 py-1.5 bg-white"
                      >
                    ...
                    <div>
                      ...
                      <select
                        {...register(`specifications.${index}.size`)}
                        className="w-full border border-gray-300 rounded text-xs px-2 py-1.5 bg-white"
                      >
                        <option value="">Any</option>
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
          ...
          {errors.imageUrls && <p className="mt-1.5 text-xs text-red-500">{errors.imageUrls.message as string}</p>}
