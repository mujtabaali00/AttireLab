...
export default function NewProductPage() {
  ...
  useEffect(() => {
    if (specifications && specifications.length > 0) {
      // Only auto-sum when at least one spec has a non-zero quantity entered
                  ...
                  <div className="col-span-12 sm:col-span-9 grid grid-cols-2 md:grid-cols-4 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full border border-gray-300 rounded text-xs px-2 py-1.5 bg-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                      >
