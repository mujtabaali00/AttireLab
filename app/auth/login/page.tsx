  ...
  return (
    <div className="flex flex-col space-y-6">
      <div className="flex flex-col space-y-2 text-center">
        ...
        <p className="text-sm text-gray-500">Welcome back to AttireLab</p>
      </div>
      ...
      <div className="relative flex py-1 items-center">
        ...
        <span className="flex-shrink mx-4 text-xs text-gray-400">or sign in with email</span>
        <div className="flex-grow border-t border-gray-200"></div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Button isLoading={isLoading} disabled={isGoogleLoading} type="submit" className="w-full">
          Login
        </Button>
      </form>
      ...
      <div className="text-center text-xs text-gray-500 space-y-2">
        <div>
          ...
          <Link href={`/auth/register${callbackUrl !== "/" ? `?callbackUrl=${encodeURIComponent(callbackUrl)}` : ""}`} className="text-blue-500 hover:underline font-medium">
            Sign Up
          </Link>
        </div>
      </div>
